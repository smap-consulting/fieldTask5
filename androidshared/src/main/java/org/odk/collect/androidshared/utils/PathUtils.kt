    ...
    fun getAbsoluteFilePath(dirPath: String, filePath: String): String {
        ...
        return try {
            ...
            if (canonicalFilePath.startsWith(canonicalDirPath)) {
                ...
                // smap - our support address, upstream's diagnostics
                throw SecurityException(
                    "Contact smap-suite@googlegroups.com. Attempt to access file outside of FieldTask directory: $absoluteFilePath\n" +
                        "dirPath: $dirPath\n" +
                        "filePath: $filePath\n" +
