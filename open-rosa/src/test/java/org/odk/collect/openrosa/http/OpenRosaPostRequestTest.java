...
public abstract class OpenRosaPostRequestTest {
    ...
    public void makesAPostRequestToUri() throws Exception {
        ...
        subject.uploadSubmissionAndFiles(new ArrayList<>(), File.createTempFile("blah", "blah"), uri, null, null, null, null, null, 0L);
    ...
    public void returnsPostResult() throws Exception {
        ...
        URI uri = mockWebServer.url("/blah").uri();
        HttpPostResult response = subject.uploadSubmissionAndFiles(new ArrayList<>(), File.createTempFile("blah", "blah"), uri, null, null, null, null, null, 0L);
    ...
    public void sendsSubmissionFileAsFirstPartOfBody() throws Exception {
        ...
        subject.uploadSubmissionAndFiles(new ArrayList<>(), tempFile, uri, null, null, null, null, null, 0L);
    ...
    public void sendsAttachmentsAsPartsOfBody() throws Exception {
        ...
        subject.uploadSubmissionAndFiles(asList(attachment1, attachment2), createTempFile("<node>content</node>"), uri, null, null, null, null, null, 1024L);
    ...
    public void sendsAttachmentsAsPartsOfBody_withContentType() throws Exception {
        ...
        subject.uploadSubmissionAndFiles(asList(xmlAttachment, plainAttachment), createTempFile("<node>content</node>"), uri, null, null, null, null, null, 1024L);
    ...
    public void whenMoreThanOneAttachment_andRequestIsLargerThanMaxContentLength_sendsTwoRequests() throws Exception {
        ...
        File attachment1 = createTempFile("blah blah blah");
        File attachment2 = createTempFile("blah2 blah2 blah2");
        subject.uploadSubmissionAndFiles(asList(attachment1, attachment2), createTempFile("<node>content</node>"), uri, null, null, null, null, null, 0L);
    ...
    public void whenMoreThanOneAttachment_andRequestIsLargerThanMaxContentLength__andFirstRequestIs500_returnsErrorResult() throws Exception {
        ...
        File attachment1 = createTempFile("blah blah blah");
        File attachment2 = createTempFile("blah2 blah2 blah2");
        HttpPostResult response = subject.uploadSubmissionAndFiles(asList(attachment1, attachment2), createTempFile("<node>content</node>"), uri, null, null, null, null, null, 0L);
