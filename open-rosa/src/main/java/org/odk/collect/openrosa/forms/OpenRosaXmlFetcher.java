...
public class OpenRosaXmlFetcher {
    ...
    public OpenRosaXmlFetcher(OpenRosaHttpInterface httpInterface, WebCredentialsProvider webCredentialsProvider, String deviceId) {  // smap - public, used outside the package
