...
public class LocationReceiver extends BroadcastReceiver {
    ...
    public void onLocationChanged(Context context, Location location) {
        ...
        if(isValidLocation(location) && isAccurateLocation(location)) {
            ...
            if(lastLocation == null || location.distanceTo(lastLocation) > ApplicationConstants.GPS_DISTANCE ) {
    ...
    private boolean isAccurateLocation(Location location) {
        ...
        if (!location.hasAccuracy() || location.getAccuracy() >= ApplicationConstants.GPS_ACCURACY) {
