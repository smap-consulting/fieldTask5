...
public class SmapChartHorizontalBarWidget extends SmapChartWidget {
    ...
    public SmapChartHorizontalBarWidget(Context context, QuestionDetails questionDetails, String appearance, Dependencies dependencies) {
        super(context, questionDetails, appearance, dependencies);
