...
public class SmapChartLineWidget extends SmapChartWidget {
    ...
    public SmapChartLineWidget(Context context, QuestionDetails qustionDetails, String appearance, Dependencies dependencies) {
        super(context, qustionDetails, appearance, dependencies);
