...
import au.smap.fieldTask.views.SmapChartMarker;
...
public abstract class SmapChartWidget extends QuestionWidget {
    ...
    public SmapChartWidget(Context context, QuestionDetails questionDetails, String appearance, Dependencies dependencies) {
