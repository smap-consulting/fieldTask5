...
/**
 * GeoCompoundWidget allows the user to collect compound geographic data
...
public class GeoCompoundWidget extends QuestionWidget implements WidgetDataReceiver {
    ...
    public GeoCompoundWidget(Context context, QuestionDetails questionDetails,
    ...
    protected View onCreateWidgetView(@NonNull Context context,
        ...
        binding.simpleButton.setOnClickListener(v ->
                geoDataRequester.requestGeoCompound(prompt, getAnswerText(), waitingForDataRegistry));
        ...
        if (getFormEntryPrompt().isReadOnly()) {
            if (dataAvailable) {
                binding.simpleButton.setText(org.odk.collect.android.R.string.geocompound_view_read_only);
            } else {
                binding.simpleButton.setVisibility(View.GONE);
            }
        } else {
            if (dataAvailable) {
                binding.simpleButton.setText(org.odk.collect.android.R.string.geocompound_view_change_location);
            } else {
                binding.simpleButton.setText(org.odk.collect.android.R.string.get_geocompound);
            }
        }
