...
import au.smap.fieldTask.tasks.SmapRemoteWebServicePostTask;
...
public class SmapRemoteDataHandlerLookupImagelabels implements IFunctionHandler {
    ...
    public SmapRemoteDataHandlerLookupImagelabels(String ident) {
        ...
        String serverUrl = (String) prefs.get(ProjectKeys.KEY_SERVER_URL);
        mServerUrlBase = serverUrl + "/lookup/imagelabels/" + ident;
    }
