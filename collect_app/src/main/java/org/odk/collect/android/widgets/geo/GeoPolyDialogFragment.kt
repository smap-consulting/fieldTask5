...
class GeoPolyDialogFragment(
    ...
    override fun onCreateFragment(
        ...
        val previousPolygons = getPreviousPolygons(prompt) // smap - "history-map"
        ...
        return GeoPolyFragment(
            ...
            previousPolygons, // smap - "history-map"
            mappableData = referenceGeometryMappableData
        )
    }

    // smap - "history-map": geometry captured by earlier instances of this repeat
