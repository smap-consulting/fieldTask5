...
public final class DatabaseConstants {
    ...
    // Version 27: Compatibility with fieldTask4 (which used version 26)
    public static final int FORMS_DATABASE_VERSION = 27; // Smap: Added PROJECT, TASKS_ONLY, READ_ONLY, SEARCH_LOCAL_DATA, SOURCE

    public static final String INSTANCES_DATABASE_NAME = "instances.db";
    public static final String INSTANCES_TABLE_NAME = "instances";
    // Please always test upgrades manually when you change this value
    // Version 27: Compatibility with fieldTask4 (which used version 26)
    public static final int INSTANCES_DATABASE_VERSION = 27; // Smap: Added task-specific columns
