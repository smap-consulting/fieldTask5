...
import static org.odk.collect.android.dynamicpreload.handler.ExternalDataSearchType.IN;
import static org.odk.collect.android.dynamicpreload.handler.ExternalDataSearchType.NOT_IN;
...
public class ExternalDataHandlerPull extends ExternalDataHandlerBase {
    ...
    public Object eval(Object[] args, EvaluationContext ec) {
        ...
        /*
         * smap
         * There are 3 variants of pulldata with 3, 4, 5 and 6 parameters
         ...
         * 5 parameters: Selects multiple records or applies a function to multiple records filtered using an sql like expression
        ...
        if (args.length < 3 || args.length > 6) { // smap add support for additional parameter combinations
            Timber.e("3, 4, 5 or 6 arguments are needed to evaluate the %s function", HANDLER_NAME); // smap
            return "";
        }
    ...
    /*
     * smap - create expression for multi-select filtering
     */
